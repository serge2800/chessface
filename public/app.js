...
const APP_VERSION = "2026-07-13-compact-game-layout-v6";
const STYLE_VERSION = "2026-07-13-compact-game-layout-v6";
...
function removeLegacyBoardAnimationSlots() {
  document.querySelectorAll(".board-animation-slots").forEach((slot) => slot.remove());
}

ensureFreshAssetLinks();
removeLegacyBoardAnimationSlots();
