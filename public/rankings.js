...
function prefetchDashboard() {
  const assets = ["/", "/app.js?v=2026-07-13-donkey-double-buffer-v1", "/styles.css?v=2026-07-13-donkey-double-buffer-v1", "/watch.html", "/watch.js?v=2026-07-13-donkey-double-buffer-v1"];
  const run = () => {
    assets.forEach((href) => {
