...
function prefetchDashboard() {
  const assets = ["/", "/app.js?v=2026-07-13-face-zoom-thinking-v1", "/styles.css?v=2026-07-13-face-zoom-thinking-v1", "/watch.html", "/watch.js?v=2026-07-13-watch-status-camera-v1"];
  const run = () => {
    assets.forEach((href) => {
