...
function prefetchDashboard() {
  const assets = ["/", "/app.js?v=2026-07-13-mobile-remote-sound-v2", "/styles.css?v=2026-07-13-mobile-remote-sound-v2", "/watch.html", "/watch.js?v=2026-07-13-watch-status-camera-v1"];
  const run = () => {
    assets.forEach((href) => {
