...
function prefetchDashboard() {
  const assets = ["/", "/app.js?v=2026-07-13-livekit-spectator-filter-v1", "/styles.css?v=2026-07-13-watch-donkey-rail-v1", "/watch.html", "/watch.js?v=2026-07-13-watch-spectator-game-v2"];
  const run = () => {
    assets.forEach((href) => {
