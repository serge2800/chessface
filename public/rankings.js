...
function prefetchDashboard() {
  const assets = ["/", "/app.js?v=2026-07-12-donkey-video-optimized-v1", "/styles.css?v=2026-07-12-watch-video-chat-v1", "/watch.html", "/watch.js?v=2026-07-12-watch-video-chat-v1"];
  const run = () => {
    assets.forEach((href) => {
